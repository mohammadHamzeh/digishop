...
@section('content')
    <div class="header">
        <h6 class="h2 mb-0 mt-3">لیست محصولات</h6>
        ...
        <div class="card">
            <div class="card-body py-0 px-3">
                <div class="col-12 p-0 py-3 d-flex align-items-center justify-content-between">
                    @can('product.add')
                        <a class="btn_add btn btn-success" href="{{url('admin/products/create')}}"><i
                                    class="far fa-plus"></i> محصول جدید </a>
                    @endcan
...
@section('javascript')
    ...
    <script>
        ...
        $('.btn_delete').click(function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    load_screen(true);
                    $.ajax({
                        url: "{{url('admin/products')}}/" + record_id,
                        type: "delete",
                        cache: false,
                        contentType: false,
                        processData: false,
        ...
        $('.btn_ban').click(function () {
            ...
            Swal.fire({
                title: "",
                text: "محصول انتخابی " + btn.attr('data-original-title') + " شود؟",
                type: "question",
                showCancelButton: true,
                buttonsStyling: false,
                confirmButtonClass: "btn btn-danger m-1",
